...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5524__auto__,k9464,else__5525__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k9464,else__5525__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__9463){
var self__ = this;
var G__9463__$1 = this;
return (new cljs.core.RecordIter((0),G__9463__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),cljs.core._iterator(self__.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5529__auto__,k__5530__auto__,G__9463){
var self__ = this;
var this__5529__auto____$1 = this;
var pred__9467 = cljs.core.keyword_identical_QMARK_;
var expr__9468 = k__5530__auto__;
if(cljs.core.truth_((pred__9467.cljs$core$IFn$_invoke$arity$2 ? pred__9467.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$status,expr__9468) : pred__9467.call(null,cljs.core.cst$kw$status,expr__9468)))){
return (new ajax.protocols.Response(G__9463,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__9467.cljs$core$IFn$_invoke$arity$2 ? pred__9467.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$body,expr__9468) : pred__9467.call(null,cljs.core.cst$kw$body,expr__9468)))){
return (new ajax.protocols.Response(self__.status,G__9463,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__9467.cljs$core$IFn$_invoke$arity$2 ? pred__9467.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$status_DASH_text,expr__9468) : pred__9467.call(null,cljs.core.cst$kw$status_DASH_text,expr__9468)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__9463,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__9467.cljs$core$IFn$_invoke$arity$2 ? pred__9467.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$headers,expr__9468) : pred__9467.call(null,cljs.core.cst$kw$headers,expr__9468)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__9463,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__9467.cljs$core$IFn$_invoke$arity$2 ? pred__9467.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$was_DASH_aborted,expr__9468) : pred__9467.call(null,cljs.core.cst$kw$was_DASH_aborted,expr__9468)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__9463,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5530__auto__,G__9463),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5521__auto__,G__9463){
var self__ = this;
var this__5521__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__9463,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__9465){
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__9465),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__9465),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__9465),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__9465),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__9465),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__9465,cljs.core.cst$kw$status,cljs.core.array_seq([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0)),null));
});
