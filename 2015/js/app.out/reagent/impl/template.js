...
var G__8723 = o;
(G__8723[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var args = cljs.core.seq(arglist__8726);
...
var old_8727 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_8727))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_8727)].join(''):class$));
} else {
}
...
var G__8730 = jsprops;
(G__8730["defaultValue"] = value);

(G__8730["onChange"] = ((function (G__8730,v,value,on_change){
return (function (p1__8728_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__8728_SHARP_);
});})(G__8730,v,value,on_change))
);
...
var vec__8732 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8732,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8732,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8732,(2),null);
...
var temp__4427__auto__ = (function (){var G__8734 = cljs.core.meta(v);
var G__8734__$1 = (((G__8734 == null))?null:reagent.impl.template.get_key(G__8734));
return G__8734__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__8736_8737 = v;
var G__8736_8738__$1 = (((G__8736_8737 == null))?null:reagent.impl.template.key_from_vec(G__8736_8737));
var G__8736_8739__$2 = (((G__8736_8738__$1 == null))?null:(jsprops["key"] = G__8736_8738__$1));
...
var G__8743 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__8743) : reagent.impl.template.as_element.call(null,G__8743));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__8744 = cljs.core.meta(argv);
var G__8744__$1 = (((G__8744 == null))?null:reagent.impl.template.get_key(G__8744));
return G__8744__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__8745 = (((jsprops == null))?{}:jsprops);
(G__8745["key"] = key);
...
var n__5811__auto___8746 = a.length;
var i_8747 = (0);
while(true){
if((i_8747 < n__5811__auto___8746)){
(a[i_8747] = reagent.impl.template.as_element((a[i_8747])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5811__auto___8749 = a.length;
var i_8750 = (0);
while(true){
if((i_8750 < n__5811__auto___8749)){
var val_8751 = (a[i_8750]);
if((cljs.core.vector_QMARK_(val_8751)) && ((reagent.impl.template.key_from_vec(val_8751) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8750] = reagent.impl.template.as_element(val_8751));
...
var G__8754 = (cljs.core.count(argv) - first_child);
switch (G__8754) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__8754){
