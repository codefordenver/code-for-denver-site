...
var or__4908__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4908__auto__)){
return or__4908__auto__;
} else {
var or__4908__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4908__auto____$1)){
return or__4908__auto____$1;
} else {
var or__4908__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4908__auto____$2)){
return or__4908__auto____$2;
} else {
var or__4908__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4908__auto____$3)){
return or__4908__auto____$3;
} else {
...
var n__5811__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5811__auto__)){
var c_8679 = (a[i]);
if(cljs.core.truth_((c_8679["cljsIsDirty"]))){
(c_8679["forceUpdate"])();
} else {
}
...
var G__8682 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__8682) : reagent.impl.batching.next_tick.call(null,G__8682));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5506__auto__,writer__5507__auto__,opt__5508__auto__){
return cljs.core._write(writer__5507__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__8684 = c;
var G__8684__$1 = (((G__8684 == null))?null:(G__8684["props"]));
var G__8684__$2 = (((G__8684__$1 == null))?null:(G__8684__$1["argv"]));
return G__8684__$2;
});
...
var G__8686_8687 = (c["cljsRatom"]);
var G__8686_8688__$1 = (((G__8686_8687 == null))?null:reagent.ratom.dispose_BANG_(G__8686_8687));
