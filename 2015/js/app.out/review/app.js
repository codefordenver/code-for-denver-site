...
review.app.circle_scale_atom = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0));
...
if(((y >= (1750))) && ((y < (2370)))){
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(review.app.circle_scale_atom,(5)) : cljs.core.reset_BANG_.call(null,review.app.circle_scale_atom,(5)));
...
var circle_scale = timothypratley.reanimated.core.spring.cljs$core$IFn$_invoke$arity$2(review.app.circle_scale_atom,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$mass,(200)], null));
var meetup_circle_scale = timothypratley.reanimated.core.spring.cljs$core$IFn$_invoke$arity$1(timothypratley.reanimated.core.scroll);
...
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$component_DASH_will_DASH_mount,((function (circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to){
return (function (){
return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic("./data/github.json",cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$response_DASH_format,cljs.core.cst$kw$json,cljs.core.cst$kw$keywords_QMARK_,true,cljs.core.cst$kw$handler,((function (circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to){
...
});})(circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to))
], null)], 0));
});})(circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to))
,cljs.core.cst$kw$component_DASH_did_DASH_mount,((function (circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to){
return (function (){
...
Chartist.Pie("#pieChart",cljs.core.clj__GT_js(pie_chart_data),cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$labelInterpolationFnc,((function (ctx,pie_chart_data,circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to){
return (function (value){
return value;
});})(ctx,pie_chart_data,circle_scale,meetup_circle_scale,scroll_y,contributors,scroll_to))
